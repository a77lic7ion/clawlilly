  ...
  return (
    <group>
      ...
      <RigidBody type="fixed" friction={1}>
        ...
        <mesh position={[0, -10, -1]} receiveShadow castShadow>
        ...
        <mesh position={[-3.5, 0, 0]} receiveShadow castShadow>
      ...
      <RigidBody type="fixed" friction={0.5}>
        ...
        <mesh position={[0, 5, -1.1]} receiveShadow castShadow>
        ...
        <mesh position={[0, 5, -2]} visible={false}>
        ...
        {/* Chute Walls */}
        <mesh position={[-1.9, 1.75, 0]} receiveShadow castShadow>
